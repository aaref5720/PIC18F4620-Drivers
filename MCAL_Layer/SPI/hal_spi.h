 ...
 * @Description This function initializes the SPI module with the provided configuration.
 * @Preconditions None
...
/**
 * @Summary Deinitializes the SPI module.
 * @Description This function deinitializes the SPI module.
 * @Preconditions SPI_Init() function should have been called before calling this function.
 * @param Config Pointer to the SPI configuration structure
 * @return Status of the function
 *          (E_OK) : The function executed successfully
 *          (E_NOT_OK) : The function encountered an issue during execution
...
/**
 * @Summary Sends a byte via SPI.
 * @Description This function sends a byte via SPI with the provided configuration.
 * @Preconditions SPI_Init() function should have been called before calling this function.
 * @param Config Pointer to the SPI configuration structure
...
/**
 * @Summary Reads a byte via SPI.
 * @Description This function reads a byte via SPI with the provided configuration.
 * @Preconditions SPI_Init() function should have been called before calling this function.
 * @param Config Pointer to the SPI configuration structure
...
/**
 * @Summary Sends a byte via SPI in a non-blocking manner.
 * @Description This function attempts to send a byte via SPI in a non-blocking mode.
 * @Preconditions SPI_Init() function should have been called before calling this function.
 * @param Config Pointer to the SPI configuration structure
 * @param _data The byte to be transmitted
 * @return Status of the function
...
/**
 * @Summary Reads a byte via SPI in a non-blocking manner.
 * @Description This function attempts to read a byte via SPI in a non-blocking mode.
 * @Preconditions SPI_Init() function should have been called before calling this function.
 * @param Config Pointer to the SPI configuration structure
 * @param _data Pointer to store the received byte
 * @return Status of the function
