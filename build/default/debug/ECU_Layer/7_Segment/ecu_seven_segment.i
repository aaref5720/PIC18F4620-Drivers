...
# 16 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 12 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_libraries.h" 1
# 12 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_libraries.h"
...
# 12 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_libraries.h" 2
...
# 13 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_libraries.h" 2
...
# 14 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/../mcal_std_libraries.h" 2
...
# 19 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h" 2
...
# 28 "ECU_Layer/7_Segment/ecu_seven_segment.h"
typedef enum
{
...
# 56 "ECU_Layer/7_Segment/ecu_seven_segment.h"
Std_ReturnType seven_segment_intialize(const segment_t *seg);
# 66 "ECU_Layer/7_Segment/ecu_seven_segment.h"
...
Std_ReturnType seven_segment_intialize(const segment_t *seg)
{
    ...
    {
        pin_config_t pin = {.PORT = seg->segment_pin_cfg[0].PORT, .PIN = seg->segment_pin_cfg[0].PIN,
                            .DIRECTION = GPIO_DIRECTION_OUTPUT, .LOGIC = seg->segment_pin_cfg[0].LED_State};
        ret = gpio_pin_intialize(&pin);

        pin.PORT = seg->segment_pin_cfg[1].PORT;
        pin.PIN = seg->segment_pin_cfg[1].PIN;
        pin.DIRECTION = GPIO_DIRECTION_OUTPUT;
        pin.LOGIC = seg->segment_pin_cfg[1].LED_State;
        ret = gpio_pin_intialize(&pin);

        pin.PORT = seg->segment_pin_cfg[2].PORT;
        pin.PIN = seg->segment_pin_cfg[2].PIN;
        pin.DIRECTION = GPIO_DIRECTION_OUTPUT;
        pin.LOGIC = seg->segment_pin_cfg[2].LED_State;
        ret = gpio_pin_intialize(&pin);

        pin.PORT = seg->segment_pin_cfg[3].PORT;
        pin.PIN = seg->segment_pin_cfg[3].PIN;
        pin.DIRECTION = GPIO_DIRECTION_OUTPUT;
        pin.LOGIC = seg->segment_pin_cfg[3].LED_State;
        ret = gpio_pin_intialize(&pin);
    }
    return ret;
}
# 59 "ECU_Layer/7_Segment/ecu_seven_segment.c"
Std_ReturnType seven_segment_write_number(const segment_t *seg, uint8 number)
{
    Std_ReturnType ret = (Std_ReturnType)0x00u;
    ...
    {
        pin_config_t pins[4] = {pins[0].PORT = seg->segment_pin_cfg[0].PORT, pins[0].PIN = seg->segment_pin_cfg[0].PIN,
                                pins[0].DIRECTION = GPIO_DIRECTION_OUTPUT, pins[0].LOGIC = seg->segment_pin_cfg[0].LED_State,

                                pins[1].PORT = seg->segment_pin_cfg[1].PORT, pins[1].PIN = seg->segment_pin_cfg[1].PIN,
                                pins[1].DIRECTION = GPIO_DIRECTION_OUTPUT, pins[1].LOGIC = seg->segment_pin_cfg[1].LED_State,

                                pins[2].PORT = seg->segment_pin_cfg[2].PORT, pins[2].PIN = seg->segment_pin_cfg[2].PIN,
                                pins[2].DIRECTION = GPIO_DIRECTION_OUTPUT, pins[2].LOGIC = seg->segment_pin_cfg[2].LED_State,

                                pins[3].PORT = seg->segment_pin_cfg[3].PORT, pins[3].PIN = seg->segment_pin_cfg[3].PIN,
                                pins[3].DIRECTION = GPIO_DIRECTION_OUTPUT, pins[3].LOGIC = seg->segment_pin_cfg[3].LED_State,
        };

        ret = gpio_pin_write_logic(&(pins[0]), ((number) & 0x01));
        ret = gpio_pin_write_logic(&(pins[1]), ((number >> 1) & 0x01));
        ret = gpio_pin_write_logic(&(pins[2]), ((number >> 2) & 0x01));
        ret = gpio_pin_write_logic(&(pins[3]), ((number >> 3) & 0x01));
