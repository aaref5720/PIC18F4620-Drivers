...
# 12 "MCAL_Layer/GPIO/../mcal_std_libraries.h"
...
Std_ReturnType gpio_pin_direction_intialize(const pin_config_t *pin_config)
{
    ...
    if(((void*)0) == pin_config || pin_config->PORT > (5 - 1)|| pin_config->PIN > (8 - 1))
    {
    ...
    else
    {
        switch(pin_config->DIRECTION)
        {
            case GPIO_DIRECTION_OUTPUT :
                (*(TRIS_REGESTERS[pin_config->PORT]) &= ~((uint8)1 << pin_config->PIN));
                break;
...
{
    Std_ReturnType ret = (Std_ReturnType)0x00u ;
    if(((void*)0) == pin_config || pin_config->PORT > (5 - 1)|| pin_config->PIN > (8 - 1) || ((void*)0) == direction_status)
    {
        ret = (Std_ReturnType)0x01u ;
    }
    else
    {
        *direction_status = ((*(TRIS_REGESTERS[pin_config->PORT]) >> pin_config->PIN) & (uint8)1);
    }
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t *pin_config, logic_t pin_logic)
{
    ...
    else
    {
        ...
        {
            case GPIO_LOW :
                (*(LAT_REGESTERS[pin_config->PORT]) &= ~((uint8)1 << pin_config->PIN));
                break;
...
{
    Std_ReturnType ret = (Std_ReturnType)0x00u ;
    if(((void*)0) == pin_config || pin_config->PORT > (5 - 1)|| pin_config->PIN > (8 - 1) || ((void*)0) == pin_logic)
    {
        ret = (Std_ReturnType)0x01u ;
    }
    else
    {
        *pin_logic = ((*PORT_REGESTERS[pin_config->PORT] >> pin_config->PIN) & (uint8)1);
    }
...
# 285 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_read_logic(PORT_INDEX_t PORT_INDEX, uint8 *port_logic)
{
    Std_ReturnType ret = (Std_ReturnType)0x00u ;
    if(PORT_INDEX > (5 - 1))
...
# 310 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_toggle_logic(PORT_INDEX_t PORT_INDEX)
{
    Std_ReturnType ret = (Std_ReturnType)0x00u ;
    if(PORT_INDEX > (5 - 1))
