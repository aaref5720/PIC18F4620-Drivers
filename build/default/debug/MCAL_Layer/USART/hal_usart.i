...
# 1 "MCAL_Layer/USART/../mcal_std_libraries.h" 1
# 12 "MCAL_Layer/USART/../mcal_std_libraries.h"
...
# 12 "MCAL_Layer/USART/../mcal_std_libraries.h" 2
...
# 13 "MCAL_Layer/USART/../mcal_std_libraries.h" 2
...
# 14 "MCAL_Layer/USART/../mcal_std_libraries.h" 2
...
# 17 "MCAL_Layer/USART/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 19 "MCAL_Layer/USART/../../MCAL_Layer/GPIO/hal_gpio.h" 2
...
# 13 "MCAL_Layer/USART/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
...
# 55 "MCAL_Layer/USART/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 13 "MCAL_Layer/USART/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h" 2
# 15 "MCAL_Layer/USART/hal_usart.h" 2

# 1 "MCAL_Layer/USART/hal_usart_cfg.h" 1
# 16 "MCAL_Layer/USART/hal_usart.h" 2
# 64 "MCAL_Layer/USART/hal_usart.h"
typedef enum{
...
static void EUSART_ASYNC_TX_Init(const usart_t *_eusart)
{
    if(1 == _eusart->usart_tx_cfg.usart_tx_enable)
    {
        ...
        if(1 == _eusart->usart_tx_cfg.usart_tx_interrupt_enable)
        {
            ...
            (PIE1bits.TXIE = 1);
# 241 "MCAL_Layer/USART/hal_usart.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
...
static void EUSART_ASYNC_RX_Init(const usart_t *_eusart)
{
    ...
    if(1 == _eusart->usart_rx_cfg.usart_rx_enable)
    {
        ...
        if(1 == _eusart->usart_rx_cfg.usart_rx_interrupt_enable)
        {
            ...
            (PIE1bits.RCIE = 1);
# 300 "MCAL_Layer/USART/hal_usart.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);
